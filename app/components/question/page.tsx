...
export const Question = (props:{img1:any, img2:any, question:string, answer:string}) => {
    ...
    return(
        ...
        <div className="sm:py-[4rem] sm:pr-[4rem] sm:pl-[12rem] sm:rounded-[3rem] drop-shadow-1 pl-[28rem] py-[12rem] pr-[12rem] relative rounded-[10rem]">
            <Image src={state === 0?props.img1:props.img2} alt="" className={`${state === 0?'sm:h-[3.5rem]':'sm:h-[0.5rem] sm:top-[5.5rem]'} sm:left-[6rem] ${state ===0?'h-[11rem]':'h-[1.6rem] top-[16rem]'} w-auto absolute left-[11rem]`} onClick={()=>{state === 0?setState(1):setState(0)}}></Image>
