    ...
    return(
        <div className={`${roboto.className} sm:mb-[10rem] px-[14rem] mb-[30rem]`}>
            ...
            <div className="sm:mx-[32rem] sm:mb-0 flex justify-center mb-[5rem] px-[10rem] py-[10rem] rounded-[2rem]">
                <div className="sm:w-[10rem] sm:h-[10rem] sm:leading-[10rem] sm:text-[3rem] w-[26rem] h-[26rem] rounded-full text-[7rem] leading-[26rem] text-center bg-[#F3F3F3] text-[#808080] font-semibold">1</div>
                <div className="sm:w-[50%] sm:h-[5rem] h-[13rem] w-[55rem] border-b-[#DADADA] border-b-[2px]"></div>
                <div className="sm:w-[10rem] sm:h-[10rem] sm:leading-[10rem] sm:text-[3rem] w-[26rem] h-[26rem] rounded-full text-[7rem] leading-[26rem] text-center primary-btn font-semibold">2</div>
            </div>
            ...
            <div className="sm:mx-[32rem] login px-[10rem] py-[10rem] rounded-[2rem]">
                ...
                <div className=" sm:mt-[13rem] sm:gap-0 flex justify-center items-center text-[6.5rem] mt-[21rem]">
